...
public enum Constantes {
    ...
    SENTENCIA_TRANSACCIONES("SELECT tipotransaccion, transaccion, columnfamily_name, sentenciacql, filtrossentenciacql FROM diewebsiten.eventos WHERE sitioweb = ? AND pagina = ? AND evento = ?"),
